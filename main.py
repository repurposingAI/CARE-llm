...
if __name__ == "__main__":
    ...
    rdf_graph = load_txt_to_rdf("/home/habes/NotebookProjects/bboi/sadok/GNN-LLM/data/dalk/datasets/DRKG_complet/DRKG_final.txt")


    chatc = load_cot()
    chat = load_llm()

    with open('/home/habes/NotebookProjects/bboi/sadok/GNN-LLM/data/dalk/datasets/DRKG_complet/DRKG_embeddings.pkl', 'rb') as f1:
    ...
    for line in lines:
        ...
        try:
            ...
            with open("/home/habes/NotebookProjects/bboi/sadok/GNN-LLM/data/dalk/datasets/DRKG_complet/DRKG_final.txt", "r", encoding="utf-8") as f:
